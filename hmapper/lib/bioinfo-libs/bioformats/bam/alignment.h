...
typedef struct alignment_batch {
    ...
    static_queue_t* alignments;		/**< Pointers to alignments. */
} alignment_batch_t;
...
*  @param decompressed_p pointer to the target decompressed array (length 2*(1+l_seq))
*  @param sequence_p sequence coded in uint8_t type
*  @param sequence_length length of the sequence
*  
*  Converts a 4 bit compressed sequence to a decompressed string
*/
