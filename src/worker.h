...
typedef struct __attribute__((__packed__)) meth_array_node {
  ...
  uint8_t c_count;      /* Number of total cytosines  */
  uint8_t nc_count;     /* Number of non-methylated cytosines */
  uint8_t mc_count;     /* Number of 5-mC cytosines   */
  uint8_t hmc_count;    /* Number of 5-hmC cytosines  */
} meth_array_node_t;
